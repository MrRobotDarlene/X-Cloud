/**
 * @file downloader.h
 * @brief download methods and definitions.
 *
...
#define DOWNLOAD_CONCURRENCY    24
#define DOWNLOAD_WRITESYNC_CONCURRENCY 4
#define DEFAULT_MIRRORS         5
#define MAX_REPORT_TRIES        2
#define MAX_TOKEN_TRIES         6
#define MAX_POINTER_TRIES       6
#define MAX_INFO_TRIES          6
