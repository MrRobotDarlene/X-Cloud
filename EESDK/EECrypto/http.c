...
int put_shard(http_options_t *http_options,
              char *farmer_id,
              char *proto,
              char *host,
              int port,
...
int fetch_shard(http_options_t *http_options,
                char *farmer_id,
                char *proto,
                char *host,
                int port,
                ...
                bool *canceled)
{
    ...
    *status_code = (int)_status_code;
    ...
    if (strcmp(shard_hash, hash) != 0) {
        error_code = HOST_INTEGRITY_ERROR;
    }
...
int fetch_json(http_options_t *http_options,
